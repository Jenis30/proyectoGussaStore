	...
	class RecuperarClave{
		public function resetearClave($identificacion, $email){
			...
			if ($f){
				...
				$actualizar = "UPDATE users SET clave=:clave WHERE identificacion=:identificacion";
...
try {
    ...
    $mail->Username   = 'gussastore30@gmail.com';                     //SMTP username
    $mail->Password   = 'wartkjoftzonvipi';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    // Emsisor datos de quien envia el email
    $mail->setFrom('gussastore30@gmail.com', 'Soporte Gussa_Store');
    ...
    $mail->Subject = 'Gussa_Store-Recuperación clave';
...
<body style="margin: 0; padding: 0;">
											...
											<tr>
												...
												<td width="400" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td align="center">
                                                            <p style="color:#fff; font-size:22px; padding-top: 30px"Esta es tu clave de ingreso: </p>
	...
	echo "<script>location.href='proyecto/travelcash/Formularios/iniciarsesion.php'</script>";
} catch (Exception $e) {
