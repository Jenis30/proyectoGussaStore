    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content">
                <div class="logo">
                    <a href="index.html">
                        <img width="200px" src="../dashboard/images/logo.png" alt="" />
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="registrarUser.php"> <i class="ti-pencil-alt"></i> Registrar</a>
                            </li>
                            <li>
                                <a href="verUsers.php"> <i class="ti-eye"></i> Ver</a>
                            </li>                           
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="productos/registrarProducto.php"> <i class="ti-pencil-alt"></i> Registrar</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="chart-flot.html"> <i class="ti-pencil-alt"></i> Registrar</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="registrarVentas.php"> <i class="ti-pencil-alt"></i> Registrar</a>
                            </li>
                            <li>
                                <a href="verVentas.php"> <i class="ti-eye"></i> Ver</a>
                            </li>                           
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                ...
                                <p>Complete los campos del formulario para registrar un nuevo usuario</p>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="file" accept=".jpg, .png, .jpeg, .gif" name="foto" required class="form-control" placeholder="Ej: Femenino">
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Crear Usuario</button>
