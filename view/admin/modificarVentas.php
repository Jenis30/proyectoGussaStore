<?php
    ...
    require_once("../../controller/mostrarInfoAdmin.php");
    require_once("../../controller/mostrarVentas.php");
            ...
            <div class="nano-content">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="producto/registrarProducto.php"> <i class="ti-pencil-alt"></i> Registrar</a>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                ...
                                <p>Modifique los campos del formulario para actualizar la información del producto</p>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
